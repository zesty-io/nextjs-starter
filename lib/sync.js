...
(async () => {
  ...
  const tasks = new Listr([
    {
      title: 'TODO: fetch instance settings',
      task: async () => {
        // TODO check if hybrid or headless is active. if not, turn on hybrid
        // TODO fetch and store instance preview password
      },
    },
    {
      title: 'TODO: collect source directory path',
      task: async () => {
        // TODO ensure provided path has trailing slash. will be need when resolving the file path for reading and writing
      },
    },
    {
      ...
      task: async (ctx) => {
        ...
        await writeNextConfig(instance);
        ctx.nextConfig = await readNextConfig();
      },
    },
    {
      title: 'Generate components',
      task: async (ctx) => {
        await createFiles(ctx.nextConfig.env.zesty);
      },
    },
    {
      title: 'TODO: update .gitignore',
      task: async () => {
...
async function createFiles(config) {
  ...
  await createComponentIndex(zestyModelsDir, gqlJSON.models);
