...
const ZestyExplorerBrowser = ({ content, children }) => {
  ...
  return (
    <div style={{ background: '#ddd', borderRadius: '10px', margin:'20px', padding: '10px', boxShadow: '0,0,5px,#333' }}>
      {children}
      ...
      <img 
        ...
        <input
          ...
          autoFocus
        />
        <a style={{ padding: '5px' }} target="_blank" href={`https://accounts.zesty.io/instances/${content.zestyInstanceZUID}`}>Open Zesty Account</a>
        <a style={{ padding: '5px' }} target="_blank" href={`https://${content.zestyInstanceZUID}.manager.zesty.io/content`}>Open Zesty Manager</a>
...
export const ZestyExplorer = ({ content }) => {
  ...
  return (
    ...
    >
      {!togglem && (
        <a  onClick={() => settoggle(true)} style={buttonStyles}  >
           <img 
            src="https://storage.googleapis.com/brand-assets.zesty.io/zesty-io-app-icon-transparent.png"
            width="32px"
            height="32px"
